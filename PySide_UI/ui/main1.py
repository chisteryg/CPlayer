...
"#volume_btn{\n"
"	border-image:"
                        " url(:/play/tools/resource/bg/icon/play/volume_2.png);\n"
"}\n"
"#mini_btn{\n"
...
"/*\u56fe\u6807*/")
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 1060, 359))
        ...
        self.widget_2.setMinimumSize(QSize(300, 170))
    ...
    def retranslateUi(self, main_music):
        ...
        self.settings_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.min_btn.setText("")
        self.min_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.max_btn.setText("")
        self.max_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.close_btn.setText("")
        self.close_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.recommend_playlist_btn.setText(QCoreApplication.translate("main_music", u"\u6bcf\u65e5\u6b4c\u5355", None))
        self.recommend_playlist_btn.setProperty(u"page", QCoreApplication.translate("main_music", u"0", None))
        self.recommend_music_btn.setText(QCoreApplication.translate("main_music", u"\u6bcf\u65e5\u63a8\u8350", None))
        self.recommend_music_btn.setProperty(u"page", QCoreApplication.translate("main_music", u"1", None))
        self.search_btn.setText(QCoreApplication.translate("main_music", u"\u641c\u7d22", None))
        self.search_btn.setProperty(u"page", QCoreApplication.translate("main_music", u"4", None))
        self.display_playlist_btn.setText(QCoreApplication.translate("main_music", u"\u6b4c\u5355", None))
        self.display_playlist_btn.setProperty(u"page", QCoreApplication.translate("main_music", u"-1", None))
        self.play_page_btn.setText(QCoreApplication.translate("main_music", u"\u64ad\u653e\u9875", None))
        self.play_page_btn.setProperty(u"page", QCoreApplication.translate("main_music", u"-1", None))
        ...
        self.music_name_lab.setProperty(u"max_length", QCoreApplication.translate("main_music", u"8", None))
        self.artists_lab.setText(QCoreApplication.translate("main_music", u"\u6b4c\u624b", None))
        self.like_btn.setText("")
        self.like_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.last_btn.setText("")
        self.last_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.play_btn.setText("")
        self.play_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.next_btn.setText("")
        self.next_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.order_btn.setText("")
        self.order_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.now_time_lab.setText(QCoreApplication.translate("main_music", u"00:00", None))
        self.now_time_lab.setProperty(u"time", QCoreApplication.translate("main_music", u"-1", None))
        self.all_time_lab.setText(QCoreApplication.translate("main_music", u"00:00", None))
        self.all_time_lab.setProperty(u"time", QCoreApplication.translate("main_music", u"-1", None))
        self.volume_btn.setText("")
        self.volume_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.mini_btn.setText("")
        self.mini_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.download_btn.setText("")
        self.download_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
        self.comments_btn.setText("")
        self.comments_btn.setProperty(u"effect", QCoreApplication.translate("main_music", u"-1", None))
    # retranslateUi
